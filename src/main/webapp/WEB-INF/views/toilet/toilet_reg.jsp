...
<script type="text/javascript">
    ...
    function initMap() {
        ...
        kakao.maps.event.addListener(map, 'click', function (mouseEvent) {
            ...
            const category = document.getElementById("post_marker_category").value;
    ...
    function moveToMyLocation() {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                if (!marker) {
                    marker = new kakao.maps.Marker({ map: map, position: loc, image: markerImage });
                } else {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.getElementById("post_marker_category").addEventListener("change", function () {
            if (marker) {
