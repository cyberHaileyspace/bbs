...
function logincheck(user) {
  if (user) location.href = "toilet/reg";
  else {
    alert("先にログインしてください。");
    location.href = "/login";
  }
        ...
        <div class="toilet-item">
            <div class="toilet-card" data-post='${postData}'>
                <div class="toilet-meta">
                    ...
                    <div class="toilet-category">[${categoryLabel}] ${
      p.post_title
    } </div>
                ...
                <div class="toilet-body">
                    <div class="toilet-image">
                        ${
                          p.post_image
                            ? `<img src='img/post/${p.post_image}' alt=''>`
                            : ""
                        }
                    </div>
                </div>
...
function openToiletModal(p) {
  ...
  const match = [...document.querySelectorAll(".toilet-card")].find(
    (card) =>
